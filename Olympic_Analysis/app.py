...
# st.sidebar.image('https://www.cleanpng.com/png-olympic-rings-png-19991/')
...
if user_menu == 'Overall Analysis':
    ...
    st.title("15 Most Successfull Athletes")
...
# What countries are good at particular sport via heatmap
# Most Successfull Athletes of that Country (Top 10)
...
if user_menu == 'Country-wise Analysis':
    ...
    # What countries are good at particular sport via heatmap
    st.title(selected_country + "'s excels in following Sport")
